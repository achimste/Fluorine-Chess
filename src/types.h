...
// Define this for 64-bit hash table keys
// #define HASH64

// MSVC, we automatically set the CPU flags as there is no Makefile
    #if defined(_MSC_VER)
        #ifdef __AVX512F__
            #define USE_AVX512 1
...
namespace Stockfish {
    ...
    constexpr Value PieceValueME[PHASE_NB][PIECE_NB] = {
...
#undef ENABLE_BASE_OPERATORS_ON
    ...
    constexpr Square relative_square(Color c, Square s) { return Square(int(s) ^ (c * 56)); }
